#############################################################################
# Makefile for building: RobotGui
# Generated by qmake (2.01a) (Qt 4.8.1) on: ?? 7? 27 14:37:42 2015
# Project:  RobotGui.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.8.1/bin/qmake -spec /usr/local/Trolltech/Qt-4.8.1/mkspecs/linux-g++ -o Makefile RobotGui.pro
#############################################################################
...
INCPATH       = -I/usr/local/Trolltech/Qt-4.8.1/mkspecs/linux-g++ -I. -I/usr/local/Trolltech/Qt-4.8.1/include/QtCore -I/usr/local/Trolltech/Qt-4.8.1/include/QtGui -I/usr/local/Trolltech/Qt-4.8.1/include -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/local/Trolltech/Qt-4.8.1/lib
LIBS          = $(SUBLIBS)  -L/usr/local/Trolltech/Qt-4.8.1/lib -lQtGui -L/usr/local/Trolltech/Qt-4.8.1/lib -L/usr/X11R6/lib -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: RobotGui.pro  /usr/local/Trolltech/Qt-4.8.1/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.8.1/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.8.1/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.8.1/mkspecs/common/gcc-base.conf \
		/usr/local/Trolltech/Qt-4.8.1/mkspecs/common/gcc-base-unix.conf \
		/usr/local/Trolltech/Qt-4.8.1/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/local/Trolltech/Qt-4.8.1/mkspecs/linux-g++ -o Makefile RobotGui.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/RobotGui1.0.0 || $(MKDIR) .tmp/RobotGui1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/RobotGui1.0.0/ && $(COPY_FILE) --parents dialog.h .tmp/RobotGui1.0.0/ && $(COPY_FILE) --parents main.cpp dialog.cpp .tmp/RobotGui1.0.0/ && $(COPY_FILE) --parents dialog.ui .tmp/RobotGui1.0.0/ && (cd `dirname .tmp/RobotGui1.0.0` && $(TAR) RobotGui1.0.0.tar RobotGui1.0.0 && $(COMPRESS) RobotGui1.0.0.tar) && $(MOVE) `dirname .tmp/RobotGui1.0.0`/RobotGui1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/RobotGui1.0.0
...
moc_dialog.cpp: dialog.h
	/usr/local/Trolltech/Qt-4.8.1/bin/moc $(DEFINES) $(INCPATH) dialog.h -o moc_dialog.cpp
...
ui_dialog.h: dialog.ui
	/usr/local/Trolltech/Qt-4.8.1/bin/uic dialog.ui -o ui_dialog.h
